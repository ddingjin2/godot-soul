...
namespace MyGame.Combat
{
    ...
    public partial class CombatTuningData : Resource
    {
        ...
        [Export] public float hitStopDurationLight = 0.08f;
        [Export] public float hitStopDurationHeavy = 0.12f;
        [Export] public float hitStopDurationParry = 0.08f;

        /// <summary>How hard the freeze bites: 0 is a dead stop, 1 is no freeze at all.</summary>
        [Export] public float hitStopPauseScale = 0.05f;
        ...
        [Export] public float shakeIntensityInvulnerable = 0.05f;
        [Export] public float shakeIntensityBossPhase = 0.5f;
        [Export] public float shakeDurationLight = 0.12f;
        [Export] public float shakeDurationMedium = 0.12f;
        [Export] public float shakeDurationHeavy = 0.25f;
        [Export] public float shakeDurationInvulnerable = 0.08f;
        [Export] public float shakeDurationBossPhase = 0.5f;

        /// <summary>Seconds a shake triggered without an explicit duration runs for.</summary>
        [Export] public float shakeDefaultDuration = 0.2f;

        /// <summary>How fast the screen rattles: the rate the shake noise is sampled at. Unitless.</summary>
        [Export] public float shakeFrequency = 25f;
        ...
        [Export] public float audioFallbackVolume = 0.75f;
