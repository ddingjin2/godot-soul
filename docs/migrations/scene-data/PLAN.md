...
| D3 | `GameplayTuningDefaults`가 디자인 파일과 7개 값에서 드리프트. **테스트 스위트가 어긋난 쪽을 만든다** | AUDIT_NUMBERS S3 |
...
D3이 가장 무겁다. 약 208개 테스트가 게임이 출하하지 않는 수치를 검증하고 있었다.
...
|---|---|---|---|
| S1 | 컷씬 오버레이 | 4 | 낮음 |
| S2 | HUD 낱개 컴포넌트 + `MenuTheme.tres` | 5 | 낮음 |
| S3 | HUD 패널과 화면 | 9 | 중간 |
| S4 | 타이틀 화면 | 5 | 중간 |
| S5 | 월드 UI와 공용 마커 | 15 | 중간 |
| S6 | 아레나 지오메트리 | 7 | 중간 |
| S7 | 이펙트와 템플릿 3종 | 10 | 중간 |
